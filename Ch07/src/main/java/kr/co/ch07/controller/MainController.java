...
public class MainController {
	...
	public String query2() {
		List<User1VO> vo = repo.findUser1VOByName("김유신");
	...
	public String query5() {
		List<User1VO> vo = repo.findUser1VOByUidOrName("j101", "김유신");
	...
	public String query6() {
		List<User1VO> vo = repo.findUser1VOByAgeGreaterThan(20);
	...
	public String query7() {
		List<User1VO> vo = repo.findUser1VOByAgeGreaterThanEqual(20);
	...
	public String query8() {
		List<User1VO> vo = repo.findUser1VOByAgeLessThan(50);
	...
	public String query9() {
		List<User1VO> vo = repo.findUser1VOByAgeLessThanEqual(50);
	...
	public String query10() {
		List<User1VO> vo = repo.findUser1VOByNameLike("김유신");
	...
	public String query17() {
		List<User1VO> vo = repo.findUser1VOByAgeGreaterThanOrderByAgeDesc(20);
	...
	public String query18() {
		int vo = repo.countUser1VOByUid("김유신");
	...
	public String query19() {
		int vo = repo.countUser1VOByName("김유신");
	...
	public String query21() {
		List<User1VO> vo = repo.selectUserByName("김유신");
	...
	public String query22() {
		List<User1VO> vo = repo.selectUserByNameWithParam("김유신");
